package com.example.cln62.day21customview;
...
public class DiaView extends View {
    ...
    public DiaView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        inti();
    }

    public DiaView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
